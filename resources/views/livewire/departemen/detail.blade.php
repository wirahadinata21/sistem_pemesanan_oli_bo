    ...
    <div class="w-full max-w-full px-3 mt-6 md:w-7/12 md:flex-none">
      <div
        ...
        <div class="p-6 px-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
          ...
          <h6 class="mb-0">Detail Departemen</h6>
          ...
          <ul class="flex flex-col pl-0 mb-0 rounded-lg">
            ...
            <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
              <div class="flex flex-col">
                <h6 class="mb-4 leading-normal text-size-sm">Departemen</h6>
                <span class="mb-2 leading-tight text-size-xs">ID Departemen: <span
                    class="font-semibold text-slate-700 sm:ml-2">{{ $tbldepartemen->iddepartemen }}</span></span>
                <span class="mb-2 leading-tight text-size-xs">Deskripsi: <span
                    class="font-semibold text-slate-700 sm:ml-2">{{ $tbldepartemen->deskripsi }}</span></span>
              </div>
            </li>
