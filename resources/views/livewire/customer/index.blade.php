<div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div class="my-auto ml-auto pr-6">
                <button type="button"                       
                        onclick="location.href='{{ url('customer/create') }}'"
                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        @foreach($tblcustomer as $value)
                            <tr>
                                ...
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> idcustomer }}</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> namaperusahaan }}</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> lokasi }}</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> pic }}</p>
                                </td>
                                <td
                                    class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-base">
                                        <a href="{{route('customer.detail', $value->idcustomer)}}"><i class="fas fa-user" aria-hidden="true"></i></a>
                                        <a href="{{route('customer.edit', $value->idcustomer)}}"><i class="fas fa-user-edit" aria-hidden="true"></i></a>
                                        <a href="{{route('customer.delete', $value->idcustomer)}}"><i class="cursor-pointer fas fa-trash" aria-hidden="true"></i></a>
                                    </p>
                                </td>
                            </tr>
                            @endforeach
        ...
        <!-- <script>
            function deleteJenisBarang(idjenisbarang) {
                if (confirm("Are you sure to delete this record?"))
                    Livewire.emit('deleteJenisBarang', idjenisbarang);
                }
        </script> -->
    </div>