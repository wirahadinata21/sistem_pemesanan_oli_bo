<div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <h6>Purchase Order Yang Sudah Di Konfirmasi Bagian Gudang</h6>
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                <div class="p-0 overflow-x-auto">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        <tbody>
                        @foreach($vieworderkfmbg as $value)
                            <tr>
                                <td
                                ...
                                <td
                                    ...
                                    <p class="mb-0 font-semibold leading-tight text-base">
                                        <a href="{{route('konfirmasi-suratjalan.detail', $value->idorder)}}"><i class="fas fa-user" aria-hidden="true"></i></a>
                                        <!-- <a href="{{route('konfirmasi-suratjalan.edit', $value->idorder)}}"><i class="fas fa-user-edit" aria-hidden="true"></i></a> -->
                                    </p>
                                </td>
                            </tr>
                            @endforeach
