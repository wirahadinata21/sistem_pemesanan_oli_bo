        ...
        <div class="flex-auto p-4 pb-0">
          <ul class="flex flex-col pl-0 mb-0 rounded-lg">
            <li
              ...
              <!-- <img src="data:image/png;base64, {{ $valueheader->lampiranpo }}" alt="Image Preview" /> -->
              <!-- <img src="data:image/jpeg;base64,{{base64_encode($valueheader->lampiranpo)}}"/> -->
            </li>
        ...
        <div class="flex-auto p-4 pt-6">
          ...
          @foreach($tokenlogorder as $log)
           ...
           @endforeach
                ...
                <div class="flow-root">
                            <a href="{{route('konfirmasi-po.delete', $valueheader->idorder)}}">
                              <button type="submit"
