<div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div class="my-auto ml-auto pr-6">
                <button type="button"                       
                        onclick="location.href='{{ url('jenis-barang/create') }}'"
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                <div class="p-0 overflow-x-auto">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        <tbody>
                        @foreach($tbljenisbarang as $value)
                            <tr>
                                <td
                                ...
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> idjenisbarang }}</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                ...
                                <td
                                    ...
                                    <p class="mb-0 font-semibold leading-tight text-base">
                                        <a href="{{route('jenis-barang.detail', $value->idjenisbarang)}}"><i class="fas fa-user" aria-hidden="true"></i></a>
                                        <a href="{{route('jenis-barang.edit', $value->idjenisbarang)}}"><i class="fas fa-user-edit" aria-hidden="true"></i></a>
                                        <a href="{{route('jenis-barang.delete', $value->idjenisbarang)}}"><i class="cursor-pointer fas fa-trash" aria-hidden="true"></i></a>
                                    </p>
                                </td>
                            </tr>
                            @endforeach
