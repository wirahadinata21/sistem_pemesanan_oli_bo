          ...
          <ul class="flex flex-col pl-0 mb-0 rounded-lg">
            ...
            <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
              <div class="flex flex-col">
                <h6 class="mb-4 leading-normal text-size-sm">Jenis Barang</h6>
                <span class="mb-2 leading-tight text-size-xs">ID Jenis Barang: <span
                    class="font-semibold text-slate-700 sm:ml-2">{{ $tbljenisbarang->idjenisbarang }}</span></span>
                <span class="mb-2 leading-tight text-size-xs">Deskripsi: <span
                    class="font-semibold text-slate-700 sm:ml-2">{{ $tbljenisbarang->deskripsi }}</span></span>
              </div>
            </li>
