        ...
        <div class="w-full px-3 mb-6 e">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    ...
                    <h5 class="font-bold py-3">Tambah User</h5>
                    ...
                    <form wire:submit.prevent="store">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="idrole" wire:model="idrole" class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow">
                                            <option value=''>Pilih Role</option>
                                            @foreach ($tblrole as $idrole => $deskripsi)
                                                <option value="{{ $idrole }}">{{ $deskripsi }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="mb-4">
                            <textarea wire:model.lazy="about" rows="4"
                                class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                placeholder="Say something about yourself" id="about">  </textarea>
