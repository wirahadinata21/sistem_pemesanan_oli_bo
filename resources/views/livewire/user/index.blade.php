<div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div class="my-auto ml-auto pr-6">
                <button type="button"                       
                        onclick="location.href='{{ url('user-management/create') }}'"
                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        @foreach($user as $value)
                            <tr>
                                ...
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{ $value -> created_at }}</p>
                                </td>
                                <td
                                    class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-base">
                                        <a href="{{route('user-management.detail', $value->id)}}"><i class="fas fa-user" aria-hidden="true"></i></a>
                                        @if ($value->idrole <> 'Customer')
                                        <a href="{{route('user-management.edit', $value->id)}}"><i class="fas fa-user-edit" aria-hidden="true"></i></a>
                                        @if ($value->idrole <> 'Admin')
                                        <a href="{{route('user-management.delete', $value->id)}}"><i class="cursor-pointer fas fa-trash" aria-hidden="true"></i></a>
                                        @endif
                                        @endif
                                    </p>
                                </td>
