  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 
    ...
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('') }}" target="_blank">
        ...
        <span
          class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">Aplikasi Pemesanan Oli</span>
      </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('jenis-satuan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('jenis-satuan') }}">

            <div
              class="{{ (Request::is('jenis-satuan') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('jenis-satuan') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Jenis Satuan</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('jenis-barang') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('jenis-barang') }}">

            <div
              class="{{ (Request::is('jenis-barang') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('jenis-barang') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Jenis Barang</span>
          </a>
        </li>
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('departemen') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('departemen') }}">

            <div
              class="{{ (Request::is('departemen') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('departemen') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Departemen</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('barang') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('barang') }}">

            <div
              class="{{ (Request::is('barang') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('barang') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Barang</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('customer') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('customer') }}">

            <div
              class="{{ (Request::is('customer') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('customer') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">customer</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('karyawan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('karyawan') }}">

            <div
              class="{{ (Request::is('karyawan') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('karyawan') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Karyawan</span>
          </a>
        </li>
        ...
        <li class="w-full mt-4">
          <h6
            class="{{ (Request::is('rtl') ? 'pr-6 mr-2' : 'pl-6 ml-2') }} font-bold leading-tight uppercase text-size-xs opacity-60">
            Transaksi Pemesanan</h6>
        </li>
        
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('konfirmasi-po') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('konfirmasi-po') }}">

            <div
              class="{{ (Request::is('konfirmasi-po') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('konfirmasi-po') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Konfirmasi PO</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('konfirmasi-gudang') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('konfirmasi-gudang') }}">

            <div
              class="{{ (Request::is('konfirmasi-gudang') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('konfirmasi-gudang') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Konfirmasi Gudang</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('konfirmasi-suratjalan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('konfirmasi-suratjalan') }}">

            <div
              class="{{ (Request::is('konfirmasi-suratjalan') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('konfirmasi-suratjalan') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Konfirmasi Surat Jalan</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('konfirmasi-pengiriman') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('konfirmasi-pengiriman') }}">

            <div
              class="{{ (Request::is('konfirmasi-pengiriman') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('konfirmasi-pengiriman') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Konfirmasi Pengiriman</span>
          </a>
        </li>
        <li class="w-full mt-4">
          <h6
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('inquiry-order') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('inquiry-order') }}">

            <div
              class="{{ (Request::is('inquiry-order') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('inquiry-order') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Inquiry Pemesanan</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('laporan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('laporan') }}">

            <div
              class="{{ (Request::is('laporan') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('laporan') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Laporan Pemesanan</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('role') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('role') }}">

            <div
              class="{{ (Request::is('role') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
